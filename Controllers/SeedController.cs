...
namespace worldcities.Controllers
{
    ...
    public class SeedController : ControllerBase
    {
        ...
        {
            // prevent non-dev env from running this method
            ...
            for (int nRow = 2; nRow <= nEndRow; nRow++)
            {
                ...
                // create the Country entity and fill it with xlxs data
            ...
            for (int nRow = 2; nRow <= nEndRow; nRow++)
            {
                ...
                // create the City entity and fill ti with xlsx data
                var city = new City
                {
                    Name = name,
