...
namespace worldcities.Data
{
    public class ApiResult<T>
    {
        ...
        /// <returns>
        /// A object containing the IQueryable pages/sorted/filtered result and all the relevant paging/sorting/filtering navigation info.
        /// </returns>
            ...
            string filterQuery = null)
        {
            ...
            if (!string.IsNullOrEmpty(filterColumn) && !string.IsNullOrEmpty(filterColumn) && IsValidProperty(filterColumn))
            {
        ...
        /// <summary>
        /// Checks if the given property name exists to protect again SQL injection attacks
        /// </summary>
        ...
        /// <summary>
        /// TRUE is the current page has a previous page, FALSE otherwise.
        /// </summary>
        ...
        /// <summary>
        /// Filter Query string (to be used with the given FilterColumn).
        /// </summary>
